...
class WorkChatDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Builder(
      builder: (BuildContext context) {
        MangerRestaurantCubit.get(context).getMessageWork();
              ...
              appBar: AppBar(
                ...
                title: Row(
                  children: [
                    ...
                    Text(
                      getTranslated(context, 'Chat_screen_chat_group_name'),
